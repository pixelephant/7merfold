	...
	var jPM = $.jPanelMenu({
     ...
     jPM.on();
      ...
      $("#sub-grid li a").click(function(){
        ...
        //Ha nincs rendes overflow scroll, akkor nincs almenü menjünk az összes oldalra

        if(overflowProbablyAlreadyWorks === null){
      ...
      $(".sub-nav .top").click(function(){
        $("#jPanelMenu-menu").animate({ scrollTop: 0 }, "slow");
        return false;
      });

...
--
-- Hoszt: localhost
-- Létrehozás ideje: 2012. dec. 21. 15:15
...
INSERT INTO `continents` (`id`, `information`, `created`, `name`, `image_file`, `slug`, `keywords`, `title`) VALUES
(1, '', '2012-12-21 10:51:32', 'Európa', '', 'europa', '', ''),
(2, '', '2012-12-21 13:42:37', 'Ázsia', '', 'azsia', '', ''),
(3, '', '2012-12-21 13:41:21', 'Afrika', '', 'afrika', '', ''),
(4, '', '0000-00-00 00:00:00', 'Észak-Amerika', '', 'eszak-amerika', '', ''),
(5, '', '0000-00-00 00:00:00', 'Dél-amerika', '', 'del-amerika', '', ''),
(6, '', '0000-00-00 00:00:00', 'Ausztrália', '', 'ausztralia', '', '');

-- --------------------------------------------------------

--
-- Tábla szerkezet: `continent_images`
--

DROP TABLE IF EXISTS `continent_images`;
CREATE TABLE IF NOT EXISTS `continent_images` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
(4, 'Első kép', '1Hamburg2_1_2.jpg', 14, '0000-00-00 00:00:00');
...
(5, 'Második hotel', 2, 'asdasdasd', '', '2322.000 Ft/fő', 18),
(6, 'Hotel', 3, 'Leírás', '', '12400', 17);
...
CREATE TABLE IF NOT EXISTS `programs` (
  ...
  PRIMARY KEY (`id`),
  KEY `trip_id` (`trip_id`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COLLATE=utf8_hungarian_ci AUTO_INCREMENT=18 ;
...
(13, 'Első program', 'Leírása', '111Hamburg2.jpg', 19),
(14, 'Első program', 'leírás hozzá', '1111Hamburg2.jpg', 22),
(15, 'Név2', 'asdsadaslékdja', '1Hamburg2.jpg_1Array', 22),
(16, '3. program', 'asdasd', '1Hamburg2.jpg_1jpg', 22),
(17, '4. nap', 'asdasdas', '2_1.png', 22);
...
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COLLATE=utf8_hungarian_ci COMMENT='Országok régióinak tárolása' AUTO_INCREMENT=6 ;
...
(3, 5, 'Kép', '1Hamburg2_3.jpg', '0000-00-00 00:00:00');
...
CREATE TABLE IF NOT EXISTS `sights` (
  ...
  `trip_id` int(11) NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COLLATE=utf8_hungarian_ci COMMENT='Látnivalók tárolása' AUTO_INCREMENT=26 ;

--
-- A tábla adatainak kiíratása `sights`
--

INSERT INTO `sights` (`id`, `name`, `image_file`, `created`, `trip_id`) VALUES
(1, 'Barcelona-1', 'bcn1.jpg', '2012-12-15 15:38:37', 0),
(2, 'Hotel képe', 'ufrascone1.jpg', '2012-12-19 13:00:02', 7),
(3, 'Hamburg-1', '1Hamburg2.jpg', '2012-12-19 13:00:02', 2),
(4, 'Hamburg-2', 'Hamburg4.jpg', '2012-12-19 13:00:02', 2),
(5, 'Hamburg-3', 'Hamburg3.jpg', '2012-12-19 13:00:02', 2),
(6, 'Cove-1', 'Atlantis_Cove8.jpg', '2012-12-19 13:00:02', 4),
(7, 'Cove-2', 'Atlantis_Cove1.jpg', '2012-12-19 13:00:02', 4),
(8, 'Cove-3', 'Atlantis_Cove15.jpg', '2012-12-19 13:00:02', 4),
(9, 'A főépület', 'jardin1.jpg', '2012-12-19 13:00:02', 9),
(10, 'Egyágyas szoba', 'jardin2.jpg', '2012-12-19 13:00:02', 9),
(11, 'Szoba', 'ufrascone2.jpg', '2012-12-19 13:00:02', 7),
(12, 'Látkép a szobából', 'ufrascone3.jpg', '2012-12-19 13:00:02', 7),
(13, 'A hotel medencéje', 'Mouettes2.jpg', '2012-12-19 13:00:02', 14),
(14, 'A hotel tengerpartja', 'Mouettes5.jpg', '2012-12-19 13:00:02', 14),
(15, 'A szoba belülről', 'Mouettes3.jpg', '2012-12-19 13:00:02', 14),
(16, 'Látkép', 'funtana1.jpg', '2012-12-19 13:00:02', 15),
(17, 'A hotel szobája', 'funtana2.jpg', '2012-12-19 13:00:02', 15),
(18, 'A szálloda medencéje', 'funtana3.jpg', '2012-12-19 13:00:02', 15),
(19, 'Barcelona-2', 'bcn2.jpg', '2012-12-15 15:38:48', 0),
(20, 'Barcelona-3', 'bcn4.jpg', '2012-12-15 15:38:59', 0),
(21, 'Csónak', '114.jpeg', '0000-00-00 00:00:00', 17),
(22, 'Első kép a galériában', '1111113.jpeg', '0000-00-00 00:00:00', 19),
(23, 'Kép a szállodáról', '111111113.jpeg', '0000-00-00 00:00:00', 20),
(24, 'Látnivaló 1.', '111logo_felirattal.jpg', '0000-00-00 00:00:00', 21),
(25, 'Galéria első eleme', '111111111113.jpeg', '0000-00-00 00:00:00', 22);
...
CREATE TABLE IF NOT EXISTS `trips` (
  ...
  `description` text COLLATE utf8_hungarian_ci NOT NULL,
  `name` varchar(255) COLLATE utf8_hungarian_ci NOT NULL,
  `price` text COLLATE utf8_hungarian_ci NOT NULL COMMENT '''Az ár leírása szövegesen''',

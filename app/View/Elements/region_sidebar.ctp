<div id="sidebar" class="no-flick">
   ...
   <section class="section" id="side-share">
    <div class="cont">
      <span class="shares"><span>Megosztás</span><a href="mailto: ?body=<?php echo $this->App->trimText(strip_tags($region['Region']['description']), 300) . "%0D" . 'A teljes ajánlat elérhető az alábbi címen: ' . $this->Html->url( null, true ); ?>&subject=7Mérföld Utazási Iroda - <?php echo $region['Region']['name']; ?>"><span class="icon" aria-hidden="true" data-icon="&#xe003;"></span></a><a target="_blank" href="http://www.facebook.com/share.php?u=<?php echo $this->Html->url( null, true ); ?>"><?php echo $this->Html->image('f_logo.png'); ?></a></span>
    </div>
  </section>

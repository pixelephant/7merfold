<!-- Látványosságok -->
	...
	?>
		<form action="<?php echo $this->webroot; ?>admin/sights/delete/<?php echo $sight['Sight']['id']; ?>" name="post_<?php echo $sight['Sight']['id']; ?>" id="post_<?php echo $sight['Sight']['id']; ?>" style="display:none;" method="post">

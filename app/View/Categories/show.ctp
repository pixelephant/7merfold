...
?>
  <section class="section selecter">
    <h2 class="clearfix info"><span><?php echo $this->Html->link($country_name . '<span class="icon" aria-hidden="true" data-icon="&#xe00d;"></span>', '/orszag/'.$country_slug, array("escape"=>false)); ?></span></h2>
  </section>
<?php
  }
?>
